...
const validateAppointmentAvailability = require("../validators/appointmentAvailabilityValidator");
...
const attachAppointmentNames = require("../utils/appointmentEnricher");

const ACTIVE_STATUSES = ["BOOKED", "COMPLETED"];

const paginateAppointments = async (filter, reqQuery, res) => {
    const { page, limit, skip } = parsePaginationOptions(reqQuery);
    ...
    const enriched = await attachAppointmentNames(appointments);
...
exports.createAppointment = async (req, res) => {
    ...
    try {
        ...
        const validAppointment = await validateAppointmentAvailability({
            patientId,
...
exports.getAppointmentById = async (req, res) => {
    ...
    try {
        ...
        const [enriched] = await attachAppointmentNames([appointment]);
