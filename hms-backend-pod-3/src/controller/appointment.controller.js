...
const getAllAppointments = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error During Get All Appointments"
        });
    }
}
...
const getDoctors = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error During Get All Doctors"
        });
    }
}
...
const getAppointmentsByPatientId = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error During Get Appointment By Patient Id"
        });
    }
}
...
const getDoctorByEmployeeId = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error During Get Doctor By Employee Id"
        });
    }
}
...
const editAppointment = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error During Edit Appointment"
        });
    }
}
...
const editAppointmentStatus = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            success: false,
            message: "Server Error During Edit Apponintment Status"
        });
    }
}
