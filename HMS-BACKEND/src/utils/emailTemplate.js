    ...
    <div style=" padding: 18px 24px; background: #f8fafc; border-bottom: 1px solid #e5e7eb; ">
        <h2 style=" margin: 0; color: #1f2937; font-size: 22px; "> 
            ...
            <div style="margin: 28px 0;"> 
                <a href="${verificationUrl}" style=" display: inline-block; padding: 12px 24px; background: rgb(15, 118, 110); color: #ffffff; text-decoration: none; border-radius: 6px; font-weight: 600; " > 
                    Verify Account </a>
            </div>
