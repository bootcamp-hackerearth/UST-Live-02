...
const verifyEmployeeDesignation = require("./employeeStatusValidator");
...
const validateAppointmentAvailability = async ({
  ...
  const validDoctor = await verifyEmployeeDesignation(doctorId, "DOCTOR");
...
module.exports = validateAppointmentAvailability;